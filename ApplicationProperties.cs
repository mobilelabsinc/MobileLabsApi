...
namespace MobileLabs.DeviceConnect.RestApi
{
    public static class ApplicationProperties
    {
        ...
        public static string OriginalApplicationBlob = "OriginalApplicationBlob";
        public static string FileName = "FileName";
        public static string ProvisionsAllDevices = "ProvisionsAllDevices";
        public static string IdOrName = "IdOrName";
    }
}
